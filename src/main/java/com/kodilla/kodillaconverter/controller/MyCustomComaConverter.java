...
public class MyCustomComaConverter implements HttpMessageConverter<Object> {

    @Override
    public boolean canRead(Class<?> clazz, MediaType mediaType) {
        return clazz.getName().equals("com.kodilla.kodillaconverter.domain.MyCustomComaClass") &&
    ...
    public Object read(Class<?> clazz, HttpInputMessage inputMessage) throws IOException {
        ...
        return new MyCustomComaClass(fields[0], fields[1], fields[2]);
    }
